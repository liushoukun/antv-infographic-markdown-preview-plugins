...
<head>
  ...
  <style>
    ...
    /* flex：图表小于视口时在可视区内水平、垂直居中（原 inline-block 会贴左上） */
    .ig-panzoom { width: 100%; min-height: 100%; box-sizing: border-box; display: flex; justify-content: center; align-items: center; }
    .ig-host { display: block; max-width: 100%; flex-shrink: 0; }
